        ...
        <div className="isolate bg-white px-6 py-24 lg:px-8">
                ...
                <div className="mx-auto max-w-4xl text-left">
                    ...
                    <div className='my-5 '>
                        ...
                        {cart.map((prod) => (
                            <div key={prod.id} className='mb-2 p-2 h-48 w-full bg-slate-200 rounded-lg text-slate-950 flex-col overflow-hidden shadow-md'>
                                <div className='text-xl text-left mb-3'>
                                    <h2 className='font-bold'> {prod.titulo} </h2>
                                </div>
                                <div className='flex gap-3 justify-between text-center items-center'>
                                    <div className='w-32'>
                                        <img className="object-cover rounded-md" src={prod.foto} alt="" />
                                    </div>
                                    <div className=''>
                                    ...
                                    <div className=''>
                                        <small className=''>Sub-total</small>
                    ...
                    <>
                        ...
                        <div className='flex justify-between items-center'>
                            <div className='mb-7 my-3'>
                                ...
                                <button className='cursor-pointer py-3 px-4 bg-slate-700 text-slate-50 rounded-full'>Finalizar Compra</button>
                        </div>
                    </>
